...
saId=$(az storage account create --name $saName --resource-group $rgName --location $location --sku Standard_RAGRS --kind StorageV2 --default-action Deny --allow-shared-key-access false --min-tls-version TLS1_2 --query id --output tsv 2>/dev/null)
